# Руководство пользователя [CLiPE (Centralized Linux Policy Engine)](https://github.com/ccrayp/CLiPE)
...
- [Руководство пользователя CLiPE (Centralized Linux Policy Engine)](#руководство-пользователя-clipe-centralized-linux-policy-engine)
  - [Аннотация](#аннотация)
  ...
  - [4. Описание операций](#4-описание-операций)
    - [4.1. Управление хостами и пользователями](#41-управление-хостами-и-пользователями)
    - [4.2. Управление политиками и правилами](#42-управление-политиками-и-правилами)
    - [4.3. Добавление модуля в PAM-таблицу](#43-добавление-модуля-в-pam-таблицу)
    - [4.4. Удаление модуля с хоста](#44-удаление-модуля-с-хоста)
    - [4.5. Просмотр логов](#45-просмотр-логов)
  - [5. Аварийные ситуации](#5-аварийные-ситуации)
    - [5.1. Сервер CLiPE недоступен](#51-сервер-clipe-недоступен)
    - [5.2. Все пользователи заблокированы на хосте](#52-все-пользователи-заблокированы-на-хосте)
    - [5.3. Ошибка при выполнении `make uninstall`](#53-ошибка-при-выполнении-make-uninstall)
    - [5.4. Ошибки SSL/TLS](#54-ошибки-ssltls)
...
![install](https://raw.githubusercontent.com/ccrayp/CLiPE/refs/heads/main/images/script_install.png)
...
```bash
curl http://<адрес_сервера>/api/v1/health
```
...
![common-account](https://raw.githubusercontent.com/ccrayp/CLiPE/refs/heads/main/images/common-account.png)
...
![common-account-debug](https://raw.githubusercontent.com/ccrayp/CLiPE/refs/heads/main/images/common-account_debug.png)
...
![uninstall](https://raw.githubusercontent.com/ccrayp/CLiPE/refs/heads/main/images/script_uninstall.png)
...
![allow](https://raw.githubusercontent.com/ccrayp/CLiPE/refs/heads/main/images/log_allow.png)
* Запрещённый доступ: запись с меткой `DENY`.
![deny](https://raw.githubusercontent.com/ccrayp/CLiPE/refs/heads/main/images/log_deny.png)

**В отладочном режиме** дополнительно выводится подробная информация о запросе и ответе сервера.
![allow](https://raw.githubusercontent.com/ccrayp/CLiPE/refs/heads/main/images/log_allow_debug.png)
